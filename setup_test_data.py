...
def setup_data():
    ...
    try:
        ...
        # Wipe tables in the correct order to avoid foreign key errors
        cursor.execute("TRUNCATE TABLE audit_log, transactions, documents, meters, wallets, tenants, tariffs, users, properties, invoices, reconciliation CASCADE;")
        ...
        conn.commit()
        print("\n✅ Success! Database wiped and fresh test data created.")
        print("\n--- PM LOGIN CREDENTIALS ---")
